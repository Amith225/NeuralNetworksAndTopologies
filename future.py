...
# from Topologies.dataBase import DataBase, FutureDataBase
# from DataSets import dataSet
# import numpy as np
#
# fdb, db = FutureDataBase.load(dataSet.TrainSets.EmnistBalanced), DataBase.load(dataSet.TrainSets.EmnistBalanced)
# fbg, bg = fdb.batchGenerator(256), db.batchGenerator(256)
#
# while 1:
#     one = fbg.__next__()[0]
#     two = bg.__next__()[0]
#     print(np.alltrue(one == two))

# from Topologies.dataBase import FutureDataBase
# from DataSets import dataSet
# import cProfile as cp
#
# fdb = FutureDataBase.load(dataSet.TrainSets.EmnistBalanced)
# fbg = fdb.batchGenerator(256)
#
#
# def fun():
#     while 1:
